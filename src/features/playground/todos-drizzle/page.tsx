...
export async function loadDrizzleTodos() {
  return await getTodos()
}

export function DrizzleTodosPage() {
  const router = useRouter()
  const todosList = useLoaderData({ from: '/demo/drizzle' })
      ...
      >
        ...
        >
          <div className="group relative">
            <div className="absolute -inset-2 rounded-lg bg-gradient-to-r from-indigo-500 via-purple-500 to-indigo-500 opacity-60 blur-lg transition duration-500 group-hover:opacity-100" />
